Shader "V/URP/ProjectroShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Texture2D _Tile, _Mask, _FalloffTex, _Noise;
			...
			float4 triplanar(float3 blendNormal, float4 texturex, float4 texturey, float4 texturez)
			{					
